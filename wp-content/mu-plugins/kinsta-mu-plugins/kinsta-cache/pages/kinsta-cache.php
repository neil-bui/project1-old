            ...
            <div class='kinsta-box'>
                ...
                <div class='kinsta-box-content'>
                    <div class='content mb22'>
                        <p><?php _e( 'Your site uses our full page and object caching technology to remain lightning fast. We recommend leaving all options on their default settings for optimal performance.', 'kinsta-cache') ?>
                        </p>
                    </div>

                    <div class='' style='border-left:6px solid #D95454; background: #FB8686; margin-bottom:22px; color: #fff; padding:22px;'><?php _e( 'The default options below are finely tuned for our servers. Please only change them if you know what you\'re doing otherwise they may actually slow down your site!', 'kinsta-cache' ) ?></div>
