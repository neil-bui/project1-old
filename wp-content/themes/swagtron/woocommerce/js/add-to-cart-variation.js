...
;(function ( $, window, document, undefined ) {
	...
	$.fn.wc_variation_form = function() {
		...
		.on( 'click', '.single_add_to_cart_button', function( event ) {
          ...
          //console.log('length: ' + $('.prod_unavail').length );
          if( $('.prod_unavail').length < 1 ) {
            $('.colorpanel').parent().prepend('<div class="alert prod_unavail" style="padding:0;margin:0;color:red;font-weight:500">Please select a color</div>');
          }
				}
			}
		} )
