						...
						<?php switch ($field->fieldType) {
                                                        case 'email':
                                                            ...
                                                            if(is_user_logged_in()){
                                                                ...
                                                                <p class="wpam_registration_input_help_text"><?php _e('This is the email address associated with your currently logged in Swagtron.com user account.', 'affiliates-manager')?></p>
                                                                <p class="wpam_registration_input_help_text"><?php _e('If you want to use a different email address, log out of your Swagtron.com account then try a new registration.', 'affiliates-manager')?></p>
                                                                <?php
                                                            }
                                                            else{
                                                            ?>
