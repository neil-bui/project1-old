...
class AFFMGR_WOO_COUPONS_ASSOC
{
    var $assoc_items = array();
    
    function AFFMGR_WOO_COUPONS_ASSOC()
    {
    ...
    function delete_item_by_id($item_id)
    {
        ...
        if($item_deleted){
            ...
            AFFMGR_WOO_COUPONS_ASSOC::save_object($this);
        }
    }
    ...
    {
        update_option('affmgr_woo_coupon_association_data', $obj_to_save);
    }
        
    static function get_instance()
    {
        $obj = get_option('affmgr_woo_coupon_association_data');
        if($obj){
            return $obj;
        }else{
            return new AFFMGR_WOO_COUPONS_ASSOC();
        }
    }
}

class AFFMGR_WOO_ASSOC_ITEM
{
    var $id;
    var $coupon_code;
    var $aff_id;

    function AFFMGR_WOO_ASSOC_ITEM($coupon_code, $aff_id)
    {
        $this->id = uniqid();
