...
<?php if(!empty($images)) { ?>
    ...
    <div class="<?php echo $this->slug; ?>-thumbnails-wrap <?php echo $this->slug; ?>-thumbnails-wrap--<?php echo $this->settings['navigation_thumbnails_type']; ?> <?php echo $this->slug; ?>-thumbnails-wrap--<?php echo $mode; ?>">
        ...
        <?php if( $this->settings['navigation_thumbnails_type'] == "sliding" && $this->settings['navigation_general_controls'] ) { ?>
    	    ...
    	    <a href="javascript: void(0);" class="<?php echo $this->slug; ?>-thumbnails__control <?php echo $this->slug; ?>-thumbnails__control--<?php echo ( $mode == "horizontal" ) ? "left" : "up"; ?>" data-direction="prev"><i class="iconic-woothumbs-icon iconic-woothumbs-icon-<?php echo ( $mode == "horizontal" ) ? "left" : "up"; ?>-open-mini"></i></a>
            <a href="javascript: void(0);" class="<?php echo $this->slug; ?>-thumbnails__control <?php echo $this->slug; ?>-thumbnails__control--<?php echo ( $mode == "horizontal" ) ? "right" : "down"; ?>" data-direction="next"><i class="iconic-woothumbs-icon iconic-woothumbs-icon-<?php echo ( $mode == "horizontal" ) ? "right" : "down"; ?>-open-mini"></i></a>
