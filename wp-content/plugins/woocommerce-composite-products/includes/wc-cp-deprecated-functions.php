...
function wc_cp_get_product_terms( $product_id, $attribute_name, $args ) {
	_deprecated_function( 'wc_cp_get_product_terms()', '3.5.2', 'WC_CP_Core_Compatibility::wc_get_product_terms()' );
	return WC_CP_Core_Compatibility::wc_get_product_terms( $product_id, $attribute_name, $args );
}

function wc_cp_get_variation_default_attribute( $product, $attribute_name ) {
	_deprecated_function( 'wc_cp_get_variation_default_attribute()', '3.5.2', 'WC_CP_Core_Compatibility::wc_get_variation_default_attribute()' );
	return WC_CP_Core_Compatibility::wc_get_variation_default_attribute( $product, $attribute_name );
}

function wc_cp_dropdown_variation_attribute_options( $args = array() ) {
	_deprecated_function( 'wc_cp_dropdown_variation_attribute_options()', '3.5.2', 'WC_CP_Core_Compatibility::wc_dropdown_variation_attribute_options()' );
...
function wc_composite_get_product_terms( $product_id, $attribute_name, $args ) {
	_deprecated_function( 'wc_composite_get_product_terms()', '3.5.0', 'WC_CP_Core_Compatibility::wc_get_product_terms()' );
	return WC_CP_Core_Compatibility::wc_get_product_terms( $product_id, $attribute_name, $args );
}

function wc_composite_get_variation_default_attribute( $product, $attribute_name ) {
	_deprecated_function( 'wc_composite_get_variation_default_attribute()', '3.5.0', 'WC_CP_Core_Compatibility::wc_get_variation_default_attribute()' );
	return WC_CP_Core_Compatibility::wc_get_variation_default_attribute( $product, $attribute_name );
}
