...
class WC_CP_Meta_Box_Product_Data {
	 ...
	 * @return void
	 */
	public static function composite_layout_options( $composite_data, $post_id ) {
		...
		?><div class="options_group bundle_group bto_clearfix">
			...
			<div class="bto_layouts bto_clearfix form-field">
				...
				<ul class="bto_clearfix bto_layouts_list">
					...
					$selected_layout = WC_Product_Composite::get_layout_option( get_post_meta( $post_id, '_bto_style', true ) );
	 ...
	 * @return void
	 */
	public static function composite_component_options( $composite_data, $post_id ) {
		...
		?><div class="options_group config_group bto_clearfix">
			<p class="toolbar">
				<span class="options_group_h3">
					...
					<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( '<strong>Components</strong> are the building blocks of a Composite product. Use Components to define the configurable parts of a Composite product.', 'woocommerce-composite-products' ) ); ?>
				</span>
	 ...
	 * @return void
	 */
	public static function layout_options_admin_html( $composite_data, $post_id ) {
		?>
	 ...
	 * @return void
	 */
	public static function component_admin_html( $id, $data, $post_id, $toggle = 'closed' ) {
	 ...
	 * @return void
	 */
	public static function scenario_admin_html( $id, $scenario_data, $composite_data, $post_id, $toggle = 'closed' ) {
	...
	public static function scenario_action_compat_group( $id, $scenario_data, $composite_data, $product_id ) {
		...
		<div class="scenario_action_compat_group" >
			<div class="form-field">
				...
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Creates a group of dependent selections from the products/variations included in this Scenario. Any selections that do not belong in this group will be disabled unless they are included in another dependency group.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public static function scenario_action_hide_components( $id, $scenario_data, $composite_data, $product_id ) {
		...
		<div class="scenario_action_conditional_components_group" >
			<div class="form-field toggle_conditional_components">
				...
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Hide one or more Components when this Scenario is active. Note that any Components added in this field will be hidden by default until the conditions for hiding or showing them can be evaluated.', 'woocommerce-composite-products' ) ); ?>
			</div>
				...
				?><div class="bto_scenario_selector">
					<div class="form-field">
						...
						<div class="bto_scenario_selector_inner" <?php echo $modifier === 'masked' ? 'style="display:none"' : ''; ?>><?php
							...
							$ajax_limit_products   = apply_filters( 'woocommerce_composite_scenario_admin_ajax_limit_products', 30, $component_id, $product_id );
							$ajax_limit_variations = apply_filters( 'woocommerce_composite_scenario_admin_ajax_limit_variations', 500, $component_id, $product_id );

							if ( count( $component_options ) < $ajax_limit_products ) {
								...
								foreach ( $component_options as $component_option_id ) {
									...
									$component_options_data[ $component_option_id ] = array( 'title' => $component_option->get_title() );
									...
									if ( $component_variations_count >= $ajax_limit_variations ) {
										break;
									}
								}
							}

							if ( $component_options_count < $ajax_limit_products && $component_variations_count < $ajax_limit_variations ) {
								...
								$select_tip   = sprintf( __( 'Select products and variations from <strong>%1$s</strong>.<br/><br/><strong>Tip</strong> &ndash; Choose the <strong>Any Product or Variation</strong> option to add all <strong>%1$s</strong> products and variations in this Scenario.%2$s', 'woocommerce-composite-products' ), $component_title, $optional_tip );
								...
								$no_selection = _x( 'No selection', 'optional component property controlled in scenarios', 'woocommerce-composite-products' );
								$optional_tip = $component_data[ 'optional' ] === 'yes' ? sprintf( __( '<br/><br/><strong>Advanced Tip</strong> &ndash; The <strong>%1$s</strong> option refers to a state where none of the available products is selected. You can use it in combination with product references to create selection dependencies, or even to make <strong>%2$s</strong> conditionally <strong>Optional</strong>.', 'woocommerce-composite-products' ), $no_selection, $component_title ) : '';
								$search_tip   = sprintf( __( 'Search for products and variations from <strong>%1$s</strong>.<br/><br/><strong>Tip</strong> &ndash; Choose the <strong>Any Product or Variation</strong> option to add all <strong>%1$s</strong> products and variations in this Scenario.%2$s', 'woocommerce-composite-products' ), $component_title, $optional_tip );
		...
		<div class="component_selection_details">
			<div class="form-field">
				<label for="component_selection_details_<?php echo $id; ?>">
					<?php echo __( 'Selected Option', 'woocommerce-composite-products' ); ?>
				</label>
				<div class="component_selection_details_option">
					...
					<span><?php echo __( 'Hide Title', 'woocommerce-composite-products' ); ?>
				...
				<div class="component_selection_details_option">
					...
					<span><?php echo __( 'Hide Description', 'woocommerce-composite-products' ); ?>
				...
				<div class="component_selection_details_option">
					...
					<span><?php echo __( 'Hide Thumbnail', 'woocommerce-composite-products' ); ?>
				...
				<div class="component_selection_details_option">
					...
					<span><?php echo __( 'Hide Price', 'woocommerce-composite-products' ); ?>
					<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Check this option to hide the selected Component Option price.', 'woocommerce-composite-products' ) ); ?>
				</div>
				<?php
		...
		<div class="component_subtotal_visibility">
			<div class="form-field">
				<label for="component_subtotal_visibility_<?php echo $id; ?>">
					<?php echo __( 'Component Price Visibility', 'woocommerce-composite-products' ); ?>
				</label>
				<div class="component_subtotal_visibility_option">
					...
					<span><?php echo __( 'Composite', 'woocommerce-composite-products' ); ?>
					<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Controls the visibility of the Component subtotal in the single-product template of the Composite.', 'woocommerce-composite-products' ) ); ?>
				</div>
				<div class="component_subtotal_visibility_option">
					...
					<span><?php echo __( 'Cart/checkout', 'woocommerce-composite-products' ); ?>
					<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Controls the visibility of the Component price/subtotal in cart/checkout templates.', 'woocommerce-composite-products' ) ); ?>
				</div>
				<div class="component_subtotal_visibility_option">
					...
					<span><?php echo __( 'Order details', 'woocommerce-composite-products' ); ?>
					<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Controls the visibility of the Component price/subtotal in order details &amp; e-mail templates.', 'woocommerce-composite-products' ) ); ?>
				</div>
			</div>
		</div>
		<?php
		...
		<div class="component_show_orderby group_show_orderby" >
			<div class="form-field">
				<label for="group_show_orderby_<?php echo $id; ?>">
					<?php echo __( 'Allow Options Sorting', 'woocommerce-composite-products' ); ?>
				</label>
				...
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Check this option to allow sorting the available Component Options by popularity, rating, newness or price.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
		...
		<div class="component_show_filters group_show_filters" >
			<div class="form-field">
				<label for="group_show_filters_<?php echo $id; ?>">
					<?php echo __( 'Allow Options Filtering', 'woocommerce-composite-products' ); ?>
				</label>
				...
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Check this option to configure and display layered attribute filters to narrow down Component Options.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div><?php
	...
	public static function component_config_title( $id, $data, $product_id ) {
		...
		<div class="component_title group_title">
			<div class="form-field">
				...
				<input type="text" class="group_title component_text_input" name="bto_data[<?php echo $id; ?>][title]" value="<?php echo $title; ?>"/><?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Name or title of this Component.', 'woocommerce-composite-products' ) ); ?>
	...
	public static function component_config_description( $id, $data, $product_id ) {
		...
		<div class="component_description group_description">
			<div class="form-field">
				...
				<textarea class="group_description" name="bto_data[<?php echo $id; ?>][description]" id="group_description_<?php echo $id; ?>" placeholder="" rows="2" cols="20"><?php echo esc_textarea( $description ); ?></textarea><?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Optional short description of this Component.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public static function component_config_options( $id, $data, $product_id ) {
		...
		<div class="component_query_type bto_query_type">
			<div class="form-field">
				...
				?></select>
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Every Component includes an assortment of products to choose from - the <strong>Component Options</strong>. You can add products individually, or select a category to add all associated products.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
	...
	public static function component_config_default_option( $id, $data, $product_id ) {
		...
		$ajax_limit_options = apply_filters( 'woocommerce_composite_component_admin_ajax_limit_defaults', 30, $component_id, $product_id );
		...
		?><div class="component_default_selector default_selector">
			<div class="form-field">
				...
				$item_ids = WC_CP_Component::query_component_options( $data );

				if ( ! empty( $item_ids ) ) {

					// If < 30 show a dropdown, otherwise show an ajax chosen field.
					if ( count( $item_ids ) < $ajax_limit_options ) {
					...
					echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Select a product that you want to use as the default, pre-selected Component Option.', 'woocommerce-composite-products' ) );

				} else {
					?><div class="prompt"><em><?php _e( 'To choose a default Component Option, you must first add some products in the Component Options field and then save your configuration&hellip;', 'woocommerce-composite-products' ); ?></em></div><?php
				}
	...
	public static function component_config_shipped_individually( $id, $data, $product_id ) {
		...
		<div class="group_shipped_individually">
			<div class="form-field">
				...
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Check this option if this Component is shipped separately from the Composite.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public static function component_config_priced_individually( $id, $data, $product_id ) {
		...
		<div class="group_priced_individually">
			<div class="form-field">
				...
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Check this option to have the price of this Component added to the base price of the Composite.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public static function component_config_discount( $id, $data, $product_id ) {
		...
		<div class="group_discount">
			<div class="form-field">
				...
				<?php echo WC_CP_Core_Compatibility::wc_help_tip( __( 'Component-level discount applied to any selected Component Option when the <strong>Priced Individually</strong> field is checked.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public static function composite_pricing_options() {
		...
		// Hide Shop Price.
		woocommerce_wp_checkbox( array( 'id' => '_bto_hide_shop_price', 'wrapper_class' => 'composite_pricing show_if_composite', 'label' => __( 'Hide Price', 'woocommerce-composite-products' ), 'desc_tip' => true, 'description' => __( 'Disable all internal price calculations and hide the Composite price displayed in the shop catalog and product summary.', 'woocommerce-composite-products' ) ) );
				...
				<div id="bto_scenarios_inner"><?php
					...
					if ( ! empty( $composite_data ) ) {
						...
						?><div id="bto-scenarios-message" class="inline notice woocommerce-message">
							<span><?php
								$tip = '<a href="#" class="tips" data-tip="' . __( 'Use Scenarios to create dependencies between Component Options, or to conditionally hide Components. Developers may use the Scenarios API to define configuration conditions for triggering custom actions.', 'woocommerce-composite-products' ) . '">' . __( 'help', 'woocommerce-composite-products' ) . '</a>';
	 ...
	 * @return array
	 */
	public static function add_composite_type( $options ) {
	...
	/**
	 * Delete price meta reserved to product bundles.
	 *
	 * @param  int  $post_id
	 * @return void
	 */
	...
	public static function save_configuration( $post_id, $posted_composite_data ) {
		...
		if ( isset( $posted_composite_data[ 'bto_data' ] ) ) {
			...
			foreach ( $posted_composite_data[ 'bto_data' ] as $row_id => $post_data ) {
				...
				if ( ! empty( $post_data[ 'title' ] ) ) {
					...
					self::add_notice( __( 'Please give a valid Name to all Components before saving.', 'woocommerce-composite-products' ), 'error' );
			...
			if ( isset( $posted_composite_data[ 'bto_scenario_data' ] ) ) {
				...
				foreach ( $posted_composite_data[ 'bto_scenario_data' ] as $scenario_id => $scenario_post_data ) {
					...
					if ( isset( $scenario_post_data[ 'title' ] ) && ! empty( $scenario_post_data[ 'title' ] ) ) {
						...
						self::add_notice( __( 'Please give a valid Name to all Scenarios before saving.', 'woocommerce-composite-products' ), 'error' );
						continue;
					}
			...
			if ( ! empty( $ordered_composite_scenario_data ) ) {
				...
				foreach ( $ordered_composite_data as $group_id => $group_data ) {
					$composite_data[ $group_id ][ 'current_component_options' ] = array( $group_data[ 'default_id' ] );
				}

				$scenarios_for_products = WC_CP_Scenarios::build_scenarios( $ordered_composite_scenario_data, $composite_data );
		...
		if ( ! isset( $posted_composite_data[ 'bto_data' ] ) || count( $composite_data ) == 0 ) {
			...
			self::add_notice( __( 'Please create at least one Component before saving. To add a Component, go to the Components tab and click on the Add Component button.', 'woocommerce-composite-products' ), 'error' );
		...
		if ( $zero_product_item_exists ) {
			self::add_notice( __( 'Please assign at least one valid Component Option to every Component. Once you have added a Component, you can add Component Options to it by selecting products individually, or by choosing product categories.', 'woocommerce-composite-products' ), 'error' );
			return false;
		}
	...
	public static function add_notice( $content, $type ) {
		...
		self::$ajax_notices[] = strip_tags( $content );
	}
}
