...
class WC_Widget_Composite extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Shows a Composite product configuration summary. Displayed only when viewing Composite product details pages.', 'woocommerce-composite-products' );
