<?php
/**
 * WCAP Dashboard Widgets
 *
 * @package     WooCommerce Abandon Cart Pro Plugin
...
class wcap_dashboard_widget {
     ...
     * Also, it will disply top abandoned product name & top recovered product
     * Also, it wil disply Last 3 abandoned carts.
     *
    ...
    public static function wcap_dashboard_widget_report( ) {
    	...
    	$reports = new Dashboard_Widget_Report; ?>
    			...
    			<table>
    			 ...
    			 <table>
    				...
    				<tbody>
    					...
    					<tr>
    						<td class="first t sales">
    							<?php //$last_month_sales = "Last MOnth vaue"; ?>
