				...
				if ( item.series.points.show || item.series.enable_tooltip ) {
					...
					if ( item.series.append_tooltip ) {
						...
						if ( "Total Revenue" == item.series.label ){
							tooltip_content = "Total Sales:" + " " + wcap_dashboard_report_params.currency_symbol + tooltip_content ;
						}else{
							tooltip_content = "Recovered Sales:" + " " + wcap_dashboard_report_params.currency_symbol + tooltip_content;
						}
					}
