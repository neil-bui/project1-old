...
<h2><?php printf( __( 'Order: %s', 'wc-pre-orders' ), $order->get_order_number() ); ?> (<?php printf( '<time datetime="%s">%s</time>', date_i18n( 'c', strtotime( $order->order_date ) ), date_i18n( wc_date_format(), strtotime( $order->order_date ) ) ); ?>)</h2>
...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1" bordercolor="#eee">
	...
	<tbody>
		<?php echo $order->email_order_items_table( array( 'sent_to_admin' => true ) ); ?>
	</tbody>
	<tfoot>
		<?php
