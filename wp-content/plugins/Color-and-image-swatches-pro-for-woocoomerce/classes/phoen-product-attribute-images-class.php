	...
	public function woocommerce_add_attribute_thumbnail_field() {
		...
		<div class="form-field ">
			...
			<select name="product_attribute_meta[<?php echo $this->meta_key; ?>][type]" id="product_attribute_swatchtype_<?php echo $this->meta_key; ?>" class="postform">
				...
				<option value="phoen_image">Image</option>
				
				<option value="phoen_icon">Icon</option>
		...
		<tr class="form-field ">
			...
			<td>
				...
				<select name="product_attribute_meta[<?php echo $this->meta_key; ?>][type]" id="product_attribute_swatchtype_<?php echo $this->meta_key; ?>" class="postform">
					...
					<option <?php selected('none', $swatch_term->get_type()); ?> value="-1"><?php _e('None', 'phoen-visual-attributes'); ?></option>
					...
					<option <?php selected('phoen_icon', $swatch_term->get_type()); ?> value="phoen_icon"><?php _e('Icon', 'phoen-visual-attributes'); ?></option>
