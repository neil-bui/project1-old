 ...
 */
class tubepress_pro_options_ioc_compiler_ProOptionsCompilerPass implements tubepress_spi_ioc_CompilerPassInterface
{
    /**
    ...
    {
        if (!$containerBuilder->has(tubepress_spi_options_PersistenceBackendInterface::_)) {

            $containerBuilder->register(
                tubepress_spi_options_PersistenceBackendInterface::_,
                'tubepress_pro_options_impl_MemoryPersistenceBackend'
